...
<html>
	...
	<body>	
		...
		<div style="position:relative; width:20%; border:solid 1px; border-right:0; float:left; margin-right:-2px;">
			<iframe width="100%" height="550px" frameborder=0 scrolling=no src="pcenter/left.jsp"></iframe>
		</div>
		<%--右侧是主页面内容  --%>
		<div style="position:relative;width:80%; border:solid 1px;float:left;margin-left:-2px;">
